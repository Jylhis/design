...
| `accent` | Bronze | `#8a4d00` | `#e0a33a` | bronze interactive accent, used as link text (AA on every surface / AAA on dark bg); ANSI slot 11 is always the bronze accent |
| `accent-hover` | Bronze | `#a75f0a` | `#f0b95c` | :hover / :active only |
...
| `accent-subtle` | Bronze | `#e9e3dd` | `#262119` | opaque approximation of accent @ ~12% on bg |
| `selection-bg` | Bronze | `#ece0cf` | `#3a2f1c` | text selection highlight (bronze-tinted) |
| `cursor` | Bronze | `#8a4d00` | `#e0a33a` | input cursor (matches accent) |
...
| `accent` | 6.28:1 | 8.64:1 |
| `accent-hover` | 4.61:1 | 10.77:1 |
| `brand` | 5.16:1 | 7.67:1 |
...
|---|---|---|---|
| `syn-keyword` | magenta-cooler — purple keyword | `#5317ac` | `#b6a0ff` |
| `syn-string` | blue-warmer — string | `#2544bb` | `#79a8ff` |
| `syn-number` | blue — number | `#0031a9` | `#79bbff` |
| `syn-function` | magenta — function name | `#721045` | `#feacd0` |
| `syn-builtin` | magenta-warmer — builtin | `#8f0075` | `#f78fe7` |
| `syn-type` | cyan-cooler — type | `#005a5f` | `#6ae4b9` |
| `syn-variable` | blue/cyan — variable | `#0044aa` | `#00d3d0` |
| `syn-comment` | fg-dim — comment (italic); AA on every surface | `#595959` | `#9a9a9a` |
| `syn-docstring` | green-faint — docstring | `#2a5a3a` | `#88ca9f` |
...
| `status-warn` | yellow (orange-leaning; avoids blue-vs-yellow tritanopia trap) | `yellow` | `#8a5000` | `#d9b34a` |
...
| 3 | yellow | `#8a5000` | `#d9b34a` | Modus yellow — warnings |
...
| 11 | bright-yellow | `#8a4d00` | `#e0a33a` | bronze accent (intentional override — ANSI 11) |
...
Size scale: `3.25 / 2 / 1.4 / 1.15 / 1.0625 / 0.95 / 0.85 / 0.8 / 0.75 / 0.72` — emitted as `--type-scale-0…9` in
...
| `row-pad-y` | 12px | 6px | 2px |
| `hit-target-min` | 44px | 36px | n/a |
| `gap-inline` | 12px | 8px | 1ch |
| `gap-block` | 24px | 16px | 1 line |
