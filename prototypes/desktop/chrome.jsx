...
function MenuBar({ openMenu, onOpenMenu, onAction, time, date, theme, onToggleTheme, cpu, mem }) {
  return (
    <div className="mock-tui-menubar" onMouseLeave={() => onOpenMenu(null)}>
      <div className="brand">
...
function WhichKey({ onClose }) {
  return (
    <div className="mock-tui-overlay" onClick={onClose}>
      <div className="mock-tui-box whichkey" onClick={(e) => e.stopPropagation()}>
...
function Help({ onClose }) {
  return (
    <div className="mock-tui-overlay" onClick={onClose}>
      <div className="mock-tui-box help" onClick={(e) => e.stopPropagation()}>
...
function Launcher({ query, items, selected, onClose }) {
  return (
    <div className="mock-tui-overlay" onClick={onClose}>
      <div className="mock-tui-box launcher" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="launcher-input">
          ...
          <span className="mock-tui-cursor"></span>
        </div>
