      ...
      <div className="drawer" onClick={(e) => e.stopPropagation()}>
        <div className="drawer-search">
          ...
          <span className="input">
            ...
            <span className="mock-tui-cursor" style={{ marginLeft: 1 }}></span>
          </span>
        </div>
...
function HwToast({ toast }) {
  return (
    <div className="hw-toast">
      ...
      <span style={{ fontSize: 10, color: 'var(--color-text-faint)' }}>F2 / F3 to adjust · Fn+M mute</span>
    </div>
  );
}
...
function App() {
  ...
  useEffect(() => {
    document.documentElement.setAttribute('data-mode', effectiveTheme === 'dark' ? 'dark' : 'light');
  }, [effectiveTheme]);
  ...
  // Stage scaling + pan fallback are handled by mocks/stage/stage.js.
  ...
  return (
    <div className="mock-stage" data-canvas="1920x1080">
      <div className="mock-stage__frame">
      <div
        className="mock-stage__canvas mock-stage__canvas--bare"
        data-screen-label={`${String(sceneIdx + 1).padStart(2, '0')} ${scene.id}`}
      >
        <div className="mock-tablet">
          <div className="mock-tablet__cam" />
          <div className="mock-tablet__screen">
            <StatusBar
              scene={scene}
              time={time}
