...
function MenuBar({ openMenu, onOpenMenu, time, date, theme,
  ...
  return (
    <div className="mock-macos-menubar" onMouseDown={(e) => e.stopPropagation()}>
...
function Spotlight({ query, results, selected, onPick, onClose }) {
  return (
    <div className="mock-macos-overlay spot" onMouseDown={onClose}>
      <div className="mock-macos-spotlight" onMouseDown={(e) => e.stopPropagation()}>
