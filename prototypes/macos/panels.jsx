...
function ControlCenter({ theme, onToggleTheme, onClose }) {
  return (
    <div className="mock-macos-panel cc" onMouseDown={(e) => e.stopPropagation()}>
...
function NotificationCenter({ date }) {
  ...
  return (
    <div className="mock-macos-panel nc" onMouseDown={(e) => e.stopPropagation()}>
      {/* notification */}
      <div className="nc-card">
        <div className="nc-note">
          ...
          <div className="body">
            ...
            <div className="msg">“jylhis-light.ase” finished exporting to ~/Downloads — 14 swatches.</div>
          </div>
        </div>
      </div>
