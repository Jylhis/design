...
function App() {
  ...
  // ── theme ──
  useEffect(() => { document.documentElement.setAttribute('data-mode', theme); }, [theme]);
  ...
  return (
    <div className="mock-stage mock-stage--vignette" data-canvas="1600x1000">
      <div className="mock-stage__frame">
        <div className="mock-stage__canvas mock-macos" data-screen-label="macos-desktop">

          <div className={`mock-macos-wallpaper wall-${tweaks.wallpaper}`} onMouseDown={closeAllPanels}>
