...
cp index.html md.html palette.html tokens.css tokens-data.js colors_and_type.css font_options.html _site/
cp -r assets preview platforms explorations source_styles docs _site/
