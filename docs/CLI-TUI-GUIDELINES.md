...
- The validators in [`../scripts/`](../scripts/) — `validate-tokens.mjs`, `validate-a11y-html.mjs`, `validate-a11y-css.mjs`, `validate-cli-conventions.mjs`, `validate-emacs-faces.mjs`, `validate-preview-hex.mjs` — encode the parts of this spec that are mechanically checkable.
