...

{
  ...
  hyprlock = [
    { src = "platforms/hyprlock/jylhis-paper.conf"; dest = "share/jylhis/hyprlock/jylhis-paper.conf"; }
    { src = "platforms/hyprlock/jylhis-roast.conf"; dest = "share/jylhis/hyprlock/jylhis-roast.conf"; }
  ];
