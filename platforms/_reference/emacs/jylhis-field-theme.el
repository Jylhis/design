...
;;
;; GENERATED from tokens.core.json + themes/jylhis.json. Do not edit by hand.
...
;;; Commentary:
;;
;;  Dark "field" edition of the Jylhis design system for Emacs.
;;  Modus-style semantic face targeting — source of truth: themes/jylhis.json
...
(deftheme jylhis-field
  "Jylhis — Field edition. Bronze accent on cool field ground, Modus Vivendi syntax.")

(let ((class '((class color) (min-colors 256)))

      ;; ── Core palette (themes/jylhis.json, dark column) ──
      (bg            "#0c0f14")
      (bg-subtle     "#14171E")
      (surface       "#1c1f24")
      (surface-raised "#262a2f")
      (fg            "#d1d4dc")
      (fg-muted      "#878b91")
      (fg-heading    "#e7ebf2")
      (fg-faint      "#5d6067")
      ...
      ;; ── Syntax / semantic — Modus role taxonomy (themes/jylhis.json) ──
      (syn-keyword   "#b4a8ff") ; from magenta-cooler
      (syn-string    "#88a4ff") ; from blue-cooler
      (syn-number    "#c2d6ff") ; from blue-warmer (constants/numbers)
      (syn-function  "#ff9ac5") ; from magenta
      (syn-builtin   "#fd74d9") ; from magenta-warmer
      (syn-type      "#0fabaa") ; from cyan-cooler
      (syn-variable  "#00a3ee") ; from cyan
      (syn-tag       "#0fabaa") ; alias of type
      (syn-comment   "#979796") ; from red-faint
  ...
  (custom-theme-set-faces
   ...
   ;; ─────────────────────────────────────────────
   ;; Font-lock  (semantic face mapping, themes/jylhis.json)
   ;; ─────────────────────────────────────────────
   ...
   ;; ─────────────────────────────────────────────
   ;; Terminal (vterm / ansi-term)  — themes/jylhis.json ANSI palette
   ;; ─────────────────────────────────────────────
   `(ansi-color-black               ((,class :foreground "#0c0f14" :background "#0c0f14")))
   `(ansi-color-red                 ((,class :foreground "#ff8271" :background "#ff8271")))
   `(ansi-color-green               ((,class :foreground "#39ae34" :background "#39ae34")))
   `(ansi-color-yellow              ((,class :foreground "#ec871d" :background "#ec871d")))
   `(ansi-color-blue                ((,class :foreground "#17a4ed" :background "#17a4ed")))
   `(ansi-color-magenta             ((,class :foreground "#ff9ac5" :background "#ff9ac5")))
   `(ansi-color-cyan                ((,class :foreground "#17a4ed" :background "#17a4ed")))
   `(ansi-color-white               ((,class :foreground "#d1d4dc" :background "#d1d4dc")))
   `(ansi-color-bright-black        ((,class :foreground "#5d6067" :background "#5d6067")))
   ...
   `(ansi-color-bright-yellow       ((,class :foreground "#f5a351" :background "#f5a351")))
   `(ansi-color-bright-blue         ((,class :foreground "#7ca2ff" :background "#7ca2ff")))
   `(ansi-color-bright-magenta      ((,class :foreground "#b4a8ff" :background "#b4a8ff")))
   `(ansi-color-bright-cyan         ((,class :foreground "#00a3ee" :background "#00a3ee")))
   `(ansi-color-bright-white        ((,class :foreground "#e7ebf2" :background "#e7ebf2")))
...
(custom-theme-set-variables
 ...
 '(ansi-color-names-vector
   ["#0c0f14" "#ff8271" "#39ae34" "#ec871d"
    "#17a4ed" "#ff9ac5" "#17a4ed" "#d1d4dc"])
