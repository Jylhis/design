...
(deftheme jylhis-sheet
  "Jylhis — light theme. Bronze accent on cool sheet, Modus-derived syntax tuned for sheet.")

(let ((class '((class color) (min-colors 256)))

      ;; ── Core palette (themes/jylhis.json, light column) ──
      (bg            "#f5f8fc")
      (bg-subtle     "#eff2f6")
      (surface       "#e9ebef")
      ...
      (syn-number    "#0031a9") ; from blue-warmer (constants/numbers)
      (syn-function  "#79194b") ; from magenta
      (syn-builtin   "#920878") ; from magenta-warmer
      (syn-type      "#005a5f") ; from cyan-cooler
      (syn-variable  "#0044aa") ; from cyan
      (syn-tag       "#005a5f") ; alias of type
      (syn-comment   "#5b5b5a") ; from red-faint
      (syn-docstring "#274d43") ; from green-faint
  ...
  (custom-theme-set-faces
   ...
   ;; ─────────────────────────────────────────────
   `(ansi-color-black               ((,class :foreground "#2a2d33" :background "#2a2d33")))
   `(ansi-color-red                 ((,class :foreground "#a40000" :background "#a40000")))
   `(ansi-color-green               ((,class :foreground "#056a04" :background "#056a04")))
   `(ansi-color-yellow              ((,class :foreground "#8a5000" :background "#8a5000")))
   `(ansi-color-blue                ((,class :foreground "#005e8a" :background "#005e8a")))
   `(ansi-color-magenta             ((,class :foreground "#79194b" :background "#79194b")))
   `(ansi-color-cyan                ((,class :foreground "#005e8a" :background "#005e8a")))
   `(ansi-color-white               ((,class :foreground "#60646b" :background "#60646b")))
   `(ansi-color-bright-black        ((,class :foreground "#8b8f96" :background "#8b8f96")))
   ...
   `(ansi-color-bright-yellow       ((,class :foreground "#a63800" :background "#a63800")))
   `(ansi-color-bright-blue         ((,class :foreground "#2b4aaa" :background "#2b4aaa")))
   `(ansi-color-bright-magenta      ((,class :foreground "#5317ac" :background "#5317ac")))
   `(ansi-color-bright-cyan         ((,class :foreground "#005a5f" :background "#005a5f")))
   `(ansi-color-bright-white        ((,class :foreground "#2a2d33" :background "#2a2d33")))
...
(custom-theme-set-variables
 ...
 '(ansi-color-names-vector
   ["#2a2d33" "#a40000" "#056a04" "#8a5000"
    "#005e8a" "#79194b" "#005e8a" "#60646b"])
