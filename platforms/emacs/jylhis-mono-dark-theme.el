;;; jylhis-mono-dark-theme.el --- Jylhis dark theme  -*- lexical-binding: t; -*-
;;
...
;;; Commentary:
;;
;;  Dark "mono-dark" edition of the Jylhis design system for Emacs.
...
;;    (load-theme 'jylhis-mono-dark t)
;;    ;; Toggle:
;;    (defun jylhis-toggle-theme ()
;;      (interactive)
;;      (if (car custom-enabled-themes)
;;          (progn (disable-theme (car custom-enabled-themes))
;;                 (load-theme (if (eq (car custom-enabled-themes) 'jylhis-mono-dark)
;;                                 'jylhis-sheet 'jylhis-mono-dark) t))))
;;
;;; Code:

(deftheme jylhis-mono-dark
  "Jylhis — Monochrome Dark edition. Bronze accent on cool mono-dark ground, Modus Vivendi syntax.")
...
(let ((class '((class color) (min-colors 256)))
      ...
      ;; ── Syntax / semantic — Modus role taxonomy, tuned for the Monochrome Dark edition (tokens.json) ──
      (syn-keyword   "#f0f0f0") ; from magenta-cooler
      (syn-string    "#c6c6c6") ; from blue-cooler
      (syn-number    "#b8b8b8") ; from blue-warmer (constants/numbers)
      (syn-function  "#e3e3e3") ; from magenta
      (syn-builtin   "#b8b8b8") ; from magenta-warmer
      (syn-type      "#d1d1d1") ; from cyan-cooler
      (syn-variable  "#adadad") ; from cyan
      (syn-tag       "#d1d1d1") ; alias of type
      (syn-comment   "#929292") ; from red-faint
      (syn-docstring "#a8e5cf") ; from green-faint
  ...
  (custom-theme-set-faces
   ...
   ;; ─────────────────────────────────────────────
   `(ansi-color-black               ((,class :foreground "#121212" :background "#121212")))
   `(ansi-color-red                 ((,class :foreground "#f0685f" :background "#f0685f")))
   `(ansi-color-green               ((,class :foreground "#6bbf6b" :background "#6bbf6b")))
   `(ansi-color-yellow              ((,class :foreground "#d9b34a" :background "#d9b34a")))
   `(ansi-color-blue                ((,class :foreground "#5fb8cf" :background "#5fb8cf")))
   `(ansi-color-magenta             ((,class :foreground "#e3e3e3" :background "#e3e3e3")))
   `(ansi-color-cyan                ((,class :foreground "#5fb8cf" :background "#5fb8cf")))
   `(ansi-color-white               ((,class :foreground "#d9d9d9" :background "#d9d9d9")))
   `(ansi-color-bright-black        ((,class :foreground "#6e6e6e" :background "#6e6e6e")))
   ...
   `(ansi-color-bright-yellow       ((,class :foreground "#e6e6e6" :background "#e6e6e6")))
   `(ansi-color-bright-blue         ((,class :foreground "#8f8f8f" :background "#8f8f8f")))
   `(ansi-color-bright-magenta      ((,class :foreground "#f0f0f0" :background "#f0f0f0")))
   `(ansi-color-bright-cyan         ((,class :foreground "#adadad" :background "#adadad")))
   `(ansi-color-bright-white        ((,class :foreground "#f5f5f5" :background "#f5f5f5")))
...
(custom-theme-set-variables
 ...
 '(ansi-color-names-vector
   ["#121212" "#f0685f" "#6bbf6b" "#d9b34a"
    "#5fb8cf" "#e3e3e3" "#5fb8cf" "#d9d9d9"])
...
(provide-theme 'jylhis-mono-dark)
...
;;; jylhis-mono-dark-theme.el ends here
