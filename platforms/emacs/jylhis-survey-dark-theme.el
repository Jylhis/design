;;; jylhis-survey-dark-theme.el --- Jylhis dark theme  -*- lexical-binding: t; -*-
;;
...
;;; Commentary:
;;
;;  Dark "survey-dark" edition of the Jylhis design system for Emacs.
...
;;    (load-theme 'jylhis-survey-dark t)
;;    ;; Toggle:
;;    (defun jylhis-toggle-theme ()
;;      (interactive)
;;      (if (car custom-enabled-themes)
;;          (progn (disable-theme (car custom-enabled-themes))
;;                 (load-theme (if (eq (car custom-enabled-themes) 'jylhis-survey-dark)
;;                                 'jylhis-sheet 'jylhis-survey-dark) t))))
;;
;;; Code:

(deftheme jylhis-survey-dark
  "Jylhis — Survey Dark edition. Bronze accent on cool survey-dark ground, Modus Vivendi syntax.")
...
(let ((class '((class color) (min-colors 256)))
      ...
      ;; ── Syntax / semantic — Modus role taxonomy, tuned for the Survey Dark edition (tokens.json) ──
      (syn-keyword   "#b6a0ff") ; from magenta-cooler
      (syn-string    "#79a8ff") ; from blue-cooler
      (syn-number    "#00bcff") ; from blue-warmer (constants/numbers)
      (syn-function  "#feacd0") ; from magenta
      (syn-builtin   "#f78fe7") ; from magenta-warmer
      (syn-type      "#6ae4b9") ; from cyan-cooler
      (syn-variable  "#00d3d0") ; from cyan
      (syn-tag       "#6ae4b9") ; alias of type
      (syn-comment   "#989898") ; from red-faint
  ...
  (custom-theme-set-faces
   ...
   ;; ─────────────────────────────────────────────
   `(ansi-color-black               ((,class :foreground "#0d0f14" :background "#0d0f14")))
   ...
   `(ansi-color-white               ((,class :foreground "#d6dae2" :background "#d6dae2")))
   `(ansi-color-bright-black        ((,class :foreground "#656b76" :background "#656b76")))
   ...
   `(ansi-color-bright-yellow       ((,class :foreground "#e0a33a" :background "#e0a33a")))
   `(ansi-color-bright-blue         ((,class :foreground "#6f9be0" :background "#6f9be0")))
   ...
   `(ansi-color-bright-white        ((,class :foreground "#f2f4f8" :background "#f2f4f8")))
...
(provide-theme 'jylhis-survey-dark)
...
;;; jylhis-survey-dark-theme.el ends here
