...
(defconst jylhis-sheet-palette
  '(
    ...
    (accent          ("#6f3e00" "color-58" "brightyellow"))
    (accent-hover    ("#8a4d00" "color-94" "yellow"))
    (accent-subtle   ("#e6e2dd" "color-254" "brightblack"))
    (brand           ("#b5450e" "color-130" "yellow"))
    (border          ("#cfd6de" "color-188" "brightblack"))
    (border-strong   ("#aab4c0" "color-249" "brightblack"))
    (decorator       ("#7f8fb5" "color-103" "brightblack"))
    (syn-keyword     ("#531ab6" "color-55" "brightmagenta"))
    (syn-string      ("#3548cf" "color-62" "brightblue"))
    (syn-number      ("#0000b0" "color-19" "blue"))
    (syn-function    ("#721045" "color-53" "magenta"))
    (syn-builtin     ("#8f0075" "color-90" "magenta"))
    (syn-type        ("#005f5f" "color-23" "cyan"))
    (syn-variable    ("#005e8b" "color-24" "brightcyan"))
    (syn-tag         ("#005f5f" "color-23" "cyan"))
    (syn-comment     ("#595959" "color-240" "white"))
    (syn-docstring   ("#2a5045" "color-238" "black"))
    (err             ("#a60000" "color-124" "red"))
    (warn            ("#884900" "color-94" "yellow"))
    ...
    (ansi-yellow     ("#884900" "color-94" "yellow"))
    ...
    (ansi-bright-green ("#316500" "color-58" "brightgreen"))
    (ansi-bright-yellow ("#6f3e00" "color-58" "brightyellow"))
