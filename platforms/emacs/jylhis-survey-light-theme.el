;;; jylhis-survey-light-theme.el --- Jylhis light theme  -*- lexical-binding: t; -*-
;;
...
;;; Commentary:
;;
;;  Light "survey-light" variant of the Jylhis design system for Emacs.
...
;;                 (load-theme (if (eq (car custom-enabled-themes) 'jylhis-survey-light)
;;                                 'jylhis-field 'jylhis-survey-light) t))))
;;
;;; Code:

(deftheme jylhis-survey-light
  "Jylhis — light theme. Bronze accent on cool survey-light, Modus-derived syntax tuned for survey-light.")
...
(let ((class '((class color) (min-colors 256)))
      ...
      ;; ── Syntax / semantic — Modus role taxonomy, tuned for survey-light (tokens.json) ──
      ...
      (syn-function  "#721045") ; from magenta
      (syn-builtin   "#8f0075") ; from magenta-warmer
      (syn-type      "#005a5f") ; from cyan-cooler
      (syn-variable  "#0044aa") ; from cyan
      (syn-tag       "#005a5f") ; alias of type
      (syn-comment   "#595959") ; from red-faint
      (syn-docstring "#2a5045") ; from green-faint
  ...
  (custom-theme-set-faces
   ...
   ;; ─────────────────────────────────────────────
   `(ansi-color-black               ((,class :foreground "#23262e" :background "#23262e")))
   ...
   `(ansi-color-blue                ((,class :foreground "#005e8b" :background "#005e8b")))
   `(ansi-color-magenta             ((,class :foreground "#721045" :background "#721045")))
   `(ansi-color-cyan                ((,class :foreground "#005e8b" :background "#005e8b")))
   `(ansi-color-white               ((,class :foreground "#565a63" :background "#565a63")))
   `(ansi-color-bright-black        ((,class :foreground "#878c95" :background "#878c95")))
   ...
   `(ansi-color-bright-yellow       ((,class :foreground "#b5450e" :background "#b5450e")))
   `(ansi-color-bright-blue         ((,class :foreground "#2f4fb0" :background "#2f4fb0")))
   ...
   `(ansi-color-bright-white        ((,class :foreground "#23262e" :background "#23262e")))
...
(provide-theme 'jylhis-survey-light)
...
;;; jylhis-survey-light-theme.el ends here
