...
just generate-check  # determinism gate (two runs, diff -r)
```
...
- Any new colour added to `themes/jylhis.json` is checked under all three CVD types.
...
| generate-check (determinism gate) | 0 | 0 | — | — |
